package com.rishabh.magicpinassigment.ui;
...
import com.rishabh.magicpinassigment.util.VideoPlayerConfig;
...
public class VideoRecyclerView extends RecyclerView {
   ...
   * {@inheritDoc}
   */
  public VideoRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public void playVideo() {
    ...
    int at = targetPosition - startPosition;
    ...
    VideoAdapter.ViewHolder holder = (VideoAdapter.ViewHolder) child.getTag();
    if (holder == null) {
      playPosition = -1;
      return;
    }
    ...
    DataSource.Factory dataSourceFactory =
        new DefaultDataSourceFactory(appContext, Util.getUserAgent(appContext, "MagicPinAssigment"),
  ...
  private int getVisibleVideoSurfaceHeight(int playPosition) {
    int at =
        playPosition - ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition();
  ...
  private void initialize(Context context) {
    ...
    LoadControl loadControl = new DefaultLoadControl(new DefaultAllocator(true, 16),
        VideoPlayerConfig.MIN_BUFFER_DURATION, VideoPlayerConfig.MAX_BUFFER_DURATION,
        VideoPlayerConfig.MIN_PLAYBACK_START_BUFFER, VideoPlayerConfig.MIN_PLAYBACK_RESUME_BUFFER,
        -1, true);
